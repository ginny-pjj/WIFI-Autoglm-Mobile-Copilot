...
# Common model output aliases -> canonical APP_PACKAGES keys
...
def resolve_app_name(app_name: str) -> str | None:
    """Resolve display name to a canonical APP_PACKAGES key."""
    ...
    if alias and alias in APP_PACKAGES:
        return alias
    return None
