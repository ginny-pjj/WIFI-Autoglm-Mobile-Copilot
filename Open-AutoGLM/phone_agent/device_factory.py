...
class DeviceFactory:
    ...
    def get_screenshot(self, device_id: str | None = None, timeout: int | None = None):
        """Get screenshot from device."""
        return self.module.get_screenshot(device_id, timeout)

    def get_ui_elements(self, device_id: str | None = None):
        """Get parsed UI tree elements when supported by the device module."""
        getter = getattr(self.module, "get_ui_elements", None)
        if getter is None:
            return []
